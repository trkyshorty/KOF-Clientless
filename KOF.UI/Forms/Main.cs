...
public partial class Main : Form {
    ...
    private void ApplicationLoad() {
        ...
        DataGridViewComboBoxColumn CharacterColumn = new()
        {
            Name = "Character",
            Width = 150,
            DisplayMember = "Name",
    ...
    private void UpdateTimer_Tick(object sender, EventArgs e) {
        ...
        foreach (DataGridViewRow row in ClientListDataGrid.Rows) {
            ...
            if (client == null)
                continue;
            if (client.CharacterHandler.Controller == null)
                continue;
    ...
    private void AddAccountButton_Click(object sender, EventArgs e) {
        if (AccountIdTextBox.Text == "" || PasswordTextBox.Text == "" || NationComboBox.SelectedIndex == byte.MaxValue || ServerListComboBox.SelectedIndex == -1)
            return;
